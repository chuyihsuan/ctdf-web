  ...
  about: [
    {
      ...
      meta: "計畫書與 README 版本資料",
      desc: "Demo 採用中華民國競技飛鏢總會與 Chinese Taipei Dart Federation 作為網站識別，預留正式網域 ctdf.org.tw 的上線設定。",
...
<body>
  <header class="site-header">
    <nav class="nav" aria-label="主要導覽">
      <a class="brand" href="/"><span class="brand-mark">CTDF</span><span><b>中華民國競技飛鏢總會</b><small>Demo Website</small></span></a>
  ...
  <footer class="footer">Demo 用途 / 未串接會員登入與資料庫 / 正式上線前需由總會確認公開資料</footer>
</body>
</html>
`;
}
...
<body>
  <header class="site-header">
    <nav class="nav" aria-label="主要導覽">
      <a class="brand" href="/"><span class="brand-mark">CTDF</span><span><b>中華民國競技飛鏢總會</b><small>Official Website Demo</small></span></a>
      <div class="nav-links">${navHtml()}</div>
    </nav>
  </header>
  ...
  <main>
    <section class="home-hero">
      <div class="home-hero-inner">
        ...
        <div class="target-panel" aria-label="飛鏢靶視覺示意">
