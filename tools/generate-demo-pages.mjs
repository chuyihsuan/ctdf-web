...
const cssEnhancements = `body{background:#f8fbff}.site-header{border-top:4px solid #d83a45;box-shadow:0 8px 24px rgba(20,32,51,.06)}.nav-links a{position:relative;padding:8px 0}.nav-links a:after{content:"";position:absolute;left:0;right:0;bottom:0;height:3px;border-radius:999px;background:#d83a45;transform:scaleX(0);transform-origin:left;transition:transform .18s ease}.nav-links a:hover:after{transform:scaleX(1)}.home-hero,.page-hero{position:relative;overflow:hidden;color:#142033;background:radial-gradient(circle at 84% 22%,rgba(21,58,107,.11),transparent 28%),radial-gradient(circle at 10% 88%,rgba(24,122,88,.1),transparent 30%),linear-gradient(135deg,#ffffff 0%,#f3f8ff 52%,#fff5f6 100%);border-bottom:1px solid #dfe8f4}.home-hero:after,.page-hero:after{content:"";position:absolute;left:0;right:0;bottom:0;height:8px;background:linear-gradient(90deg,#d83a45,#f6c85f,#61b99a,#2f6fb0);opacity:.9}.home-hero-inner,.page-hero-inner{position:relative;z-index:1}.home-hero p,.page-hero p{color:#475467}.eyebrow{color:#2f6fb0}.title-icon{border-color:#d9e7f7;background:#fff;box-shadow:0 10px 24px rgba(21,58,107,.08)}.target-panel{position:relative}.target-panel:before{content:"";position:absolute;inset:-18px;border:1px solid #dfe8f4;border-radius:8px;background:rgba(255,255,255,.76);box-shadow:0 18px 42px rgba(21,58,107,.1);z-index:-1}.stat-row span{background:#f4f8ff;color:#475467;border:1px solid #dfe8f4}.stat-row b{color:#2f6fb0}.button{background:#d83a45;box-shadow:0 12px 22px rgba(216,58,69,.18)}.button.secondary{border:1px solid #bfd2e8;background:#fff;color:#153a6b}.portal-band{padding:46px 0;background:linear-gradient(180deg,#fff,#f5fbff);color:#142033;border-top:0;border-bottom:1px solid #dfe8f4}.portal-head{display:flex;align-items:flex-end;justify-content:space-between;gap:18px;margin-bottom:18px}.portal-head h2{max-width:620px;margin:0;font-size:30px;line-height:1.25}.portal-head .eyebrow{margin:0;color:#2f6fb0}.portal-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.portal-card{position:relative;display:grid;align-content:start;gap:10px;min-height:150px;padding:18px;border:1px solid #dfe8f4;border-radius:8px;background:#fff;box-shadow:0 16px 34px rgba(21,58,107,.07);overflow:hidden}.portal-card:nth-child(1){background:#f5f9ff}.portal-card:nth-child(2){background:#fff7f7}.portal-card:nth-child(3){background:#f4fbf8}.portal-card:nth-child(4){background:#fffaf0}.portal-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#2f6fb0}.portal-card:nth-child(2):before{background:#d83a45}.portal-card:nth-child(3):before{background:#61b99a}.portal-card:nth-child(4):before{background:#f6c85f}.portal-card span{position:relative;color:#153a6b;font-size:20px;font-weight:900;line-height:1.35}.portal-card p{position:relative;margin:0;color:#526277;line-height:1.6}.portal-card:hover{border-color:#b9cce4;transform:translateY(-2px)}.section{background:#fff}.section:nth-of-type(even){background:#f7fbff}.section.alt{background:#fff}.section.real-data{background:#f6faff}.section-head h2{position:relative;padding-left:14px}.section-head h2:before{content:"";position:absolute;left:0;top:.18em;bottom:.18em;width:4px;border-radius:999px;background:#d83a45}.news-item,.event-item,.player-row,.download-row,.about-block,.link-card,.table-wrap{position:relative;overflow:hidden;border-color:#dfe8f4;box-shadow:0 12px 28px rgba(21,58,107,.06)}.news-item:before,.event-item:before,.player-row:before,.download-row:before,.about-block:before,.link-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:#d83a45}.event-item:before{background:#61b99a}.player-row:before{background:#2f6fb0}.download-row:before{background:#f6c85f}.about-block:before,.link-card:before{background:#9db8d8}.ranking-table th{background:#edf5ff;color:#153a6b}.ranking-table tbody tr:nth-child(even){background:#fbfdff}.avatar{box-shadow:inset 0 0 0 4px rgba(255,255,255,.38);background:linear-gradient(135deg,#2f6fb0,#61b99a)}.tag,.file-badge{border:1px solid rgba(21,58,107,.12);background:#f3f8ff}.footer{background:#f2f7fc;color:#475467;border-top:1px solid #dfe8f4}.footer b,.footer a{color:#153a6b}.footer-note{color:#7a8ba1}@media (max-width:900px){.portal-head{align-items:flex-start;flex-direction:column}.portal-grid{grid-template-columns:1fr 1fr}.target-panel:before{inset:-10px}}@media (max-width:640px){.portal-grid{grid-template-columns:1fr}.portal-card{min-height:auto}}`;
