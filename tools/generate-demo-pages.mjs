    ...
    <section class="home-hero">
      <div class="home-hero-inner">
        ...
        <div class="target-panel" aria-label="CTDF 視覺識別">
          <img class="cover-image" src="/assets/ctdf-facebook-cover.png" alt="中華民國競技飛鏢總會 CTDF 封面圖">
