...
const cssEnhancements = `.site-header{border-top:4px solid var(--red);box-shadow:0 8px 28px rgba(20,32,51,.08)}.nav-links a{position:relative;padding:8px 0}.nav-links a:after{content:"";position:absolute;left:0;right:0;bottom:0;height:3px;border-radius:999px;background:var(--red);transform:scaleX(0);transform-origin:left;transition:transform .18s ease}.nav-links a:hover:after{transform:scaleX(1)}.home-hero,.page-hero{position:relative;overflow:hidden;background:radial-gradient(circle at 82% 22%,rgba(255,255,255,.18),transparent 28%),radial-gradient(circle at 10% 88%,rgba(24,122,88,.28),transparent 28%),linear-gradient(105deg,rgba(7,20,39,.98),rgba(21,58,107,.92)),linear-gradient(135deg,#0a172b,#153a6b 58%,#c92c35 128%)}.home-hero:after,.page-hero:after{content:"";position:absolute;inset:auto -10% -58px -10%;height:115px;background:linear-gradient(90deg,rgba(201,44,53,.92),rgba(255,209,102,.86),rgba(24,122,88,.82));transform:skewY(-2.5deg);opacity:.45}.home-hero-inner,.page-hero-inner{position:relative;z-index:1}.target-panel{position:relative}.target-panel:before{content:"";position:absolute;inset:-18px;border:1px solid rgba(255,255,255,.18);border-radius:8px;background:linear-gradient(160deg,rgba(255,255,255,.12),rgba(255,255,255,.04));z-index:-1}.portal-band{padding:46px 0;background:#0b1730;color:#fff;border-top:4px solid var(--red);border-bottom:1px solid rgba(255,255,255,.1)}.portal-head{display:flex;align-items:flex-end;justify-content:space-between;gap:18px;margin-bottom:18px}.portal-head h2{max-width:620px;margin:0;font-size:30px;line-height:1.25}.portal-head .eyebrow{margin:0;color:var(--gold)}.portal-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.portal-card{position:relative;display:grid;align-content:start;gap:10px;min-height:150px;padding:18px;border:1px solid rgba(255,255,255,.16);border-radius:8px;background:linear-gradient(160deg,rgba(255,255,255,.14),rgba(255,255,255,.05));box-shadow:0 18px 36px rgba(0,0,0,.2);overflow:hidden}.portal-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:var(--gold)}.portal-card span{position:relative;color:#fff;font-size:20px;font-weight:900;line-height:1.35}.portal-card p{position:relative;margin:0;color:#c8d7eb;line-height:1.6}.portal-card:hover{border-color:rgba(255,209,102,.6);transform:translateY(-2px)}.section{background:linear-gradient(180deg,#f7faff,#edf3fb)}.section.alt{background:#fff}.section.real-data{background:linear-gradient(180deg,#eef4fb,#f7faff)}.section-head h2{position:relative;padding-left:14px}.section-head h2:before{content:"";position:absolute;left:0;top:.18em;bottom:.18em;width:4px;border-radius:999px;background:var(--red)}.news-item,.event-item,.player-row,.download-row,.about-block,.link-card,.table-wrap{position:relative;overflow:hidden}.news-item:before,.event-item:before,.player-row:before,.download-row:before,.about-block:before,.link-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;background:linear-gradient(180deg,var(--red),var(--navy))}.ranking-table th{background:#0f2d55;color:#fff}.ranking-table tbody tr:nth-child(even){background:#f8fbff}.avatar{box-shadow:inset 0 0 0 4px rgba(255,255,255,.18);background:linear-gradient(135deg,var(--navy),#0a172b)}.tag,.file-badge{border:1px solid rgba(21,58,107,.12);background:#f1f6ff}.button{box-shadow:0 12px 24px rgba(201,44,53,.24)}.button.secondary:hover,.button:hover{filter:brightness(1.04)}@media (max-width:900px){.portal-head{align-items:flex-start;flex-direction:column}.portal-grid{grid-template-columns:1fr 1fr}.target-panel:before{inset:-10px}}@media (max-width:640px){.portal-grid{grid-template-columns:1fr}.portal-card{min-height:auto}.home-hero:after,.page-hero:after{height:82px;bottom:-48px}}`;
